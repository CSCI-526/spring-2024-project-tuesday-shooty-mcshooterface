...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [Tooltip("The rotation speed of the character by settings ")]
        public float RotationSettingsMult { get; set; } = 1.0f;
        ...
        private void CameraRotation()
        {
            ...
            if (_input.look.sqrMagnitude >= _threshold)
            {
                ...
                float effectiveRotationSpeed = RotationSpeed * RotationSettingsMult;
#if WEBGL
