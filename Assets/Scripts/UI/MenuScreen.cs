...
public class MenuScreen : MonoBehaviour
{
    ...
    {
        rectTransform
            .DOAnchorPosX(0, uiConstants.menuScreenTransitionTime)
            .SetUpdate(true)
            .onComplete += EnableFunctionality;
        canvasGroup
            .DOFade(1, uiConstants.menuScreenTransitionTime)
            .SetUpdate(true)
    ...
    public void PutAway()
    {
        DisableFunctionality();
        rectTransform
            .DOAnchorPosX(-uiConstants.offscreenDistance, uiConstants.menuScreenTransitionTime)
            .SetUpdate(true);
        canvasGroup
            .DOFade(0, uiConstants.menuScreenTransitionTime)
            .SetUpdate(true)
            .SetEase(Ease.OutSine);
    }
