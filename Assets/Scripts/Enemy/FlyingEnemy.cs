...
public class FlyingEnemy : BaseEnemy
{
    ...
    [SerializeField]
    private float projectileTimeToLive = 5.0f;
    ...
    private IEnumerator SetAttack()
    {
        while (true)
        {
            ...
            yield return new WaitForSeconds(attackCooldown * mult + Random.Range(0.0f, 0.5f));
        }
    }
    ...
    private void ToStrafe()
    {
        ...
        Vector3 rawStrafeDirection =
            Vector3.Cross(_toPlayer, _upVector).normalized * directionFactor;
    ...
    private void toAttack()
    {
        ...
        projectile
            ...
            .AddForce(_toPlayer3 * projectileSpeed, ForceMode.Impulse);
